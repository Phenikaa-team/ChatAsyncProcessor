...
class MonitoringIntegration {
    companion object {
        ...
        fun logEvent(level: MonitoringService.LogLevel, eventType: MonitoringService.EventType,
                     message: String, details: Map<String, Any> = emptyMap()) {
        ...
        fun initializeMonitoring() {
            logEvent(
                MonitoringService.LogLevel.INFO,
                MonitoringService.EventType.SYSTEM,
...
fun String.logAsSystem(level: MonitoringService.LogLevel = MonitoringService.LogLevel.INFO) {
    MonitoringIntegration.logEvent(level, MonitoringService.EventType.SYSTEM, this)
}

fun String.logAsError(exception: Throwable? = null, context: Map<String, Any> = emptyMap()) {
    MonitoringIntegration.logError(this, exception, context)
}

fun Throwable.logError(message: String = this.message ?: "Unknown error", context: Map<String, Any> = emptyMap()) {
